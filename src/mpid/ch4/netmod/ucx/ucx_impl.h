...
#define MPIDI_UCX_COMM_TO_EP(comm,rank,hst_vni,rmt_vni) \
    MPIDI_UCX_AV(MPIDIU_comm_rank_to_av(comm, rank)).dest[hst_vni][rmt_vni]
#define MPIDI_UCX_AV_TO_EP(av,hst_vni,rmt_vni) MPIDI_UCX_AV((av)).dest[hst_vni][rmt_vni]
