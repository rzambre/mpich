...
int MPIDI_NM_vni_alloc(MPIDI_vni_resource_t resources, MPIDI_vni_property_t properties, int *vni)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_NM_VNI_ALLOC);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_NM_MPI_VNI_ALLOC);

    ret = MPIDI_NM_native_func->vni_alloc(resources, properties, vni);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_NM_MPI_VNI_ALLOC);
    return ret;
}
...
int MPIDI_NM_vni_free(int vni)
{
    ...
    MPIR_FUNC_VERBOSE_STATE_DECL(MPID_STATE_MPIDI_NM_VNI_FREE);
    MPIR_FUNC_VERBOSE_ENTER(MPID_STATE_MPIDI_NM_MPI_VNI_FREE);

    ret = MPIDI_NM_native_func->vni_free(vni);

    MPIR_FUNC_VERBOSE_EXIT(MPID_STATE_MPIDI_NM_MPI_VNI_FREE);
    return ret;
}
