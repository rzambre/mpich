...
typedef int (*MPIDI_NM_get_vci_resource_info_t) (int vci);
...
typedef struct MPIDI_NM_funcs {
    ...
    MPIDI_NM_get_vci_resource_info_t get_vci_resource_info;
...
MPL_STATIC_INLINE_PREFIX int MPIDI_NM_get_vci_resource_info(int vci) MPL_STATIC_INLINE_SUFFIX;
