                                               ...
                                               int hst_vci, int rmt_vci)
{
    ...
    mpi_errno =
        MPIDI_NM_mpi_send(buf, count, datatype, rank, tag, comm, context_offset, av, request, hst_vci, rmt_vci);
#else
    int r;
...
#ifdef MPIDI_CH4_DIRECT_NETMOD
    mpi_errno =
        MPIDI_NM_mpi_isend(buf, count, datatype, rank, tag, comm, context_offset, av, request, hst_vci, rmt_vci);
#else
    int r;
    if ((r = MPIDI_av_is_local(av)))
        mpi_errno =
...
#ifdef MPIDI_CH4_DIRECT_NETMOD
    mpi_errno = MPIDI_NM_mpi_ssend(buf, count, datatype, rank, tag, comm, context_offset, av, req, hst_vci, rmt_vci);
#else
    int r;
    if ((r = MPIDI_av_is_local(av)))
        mpi_errno =
...
#ifdef MPIDI_CH4_DIRECT_NETMOD
    mpi_errno = MPIDI_NM_mpi_issend(buf, count, datatype, rank, tag, comm, context_offset, av, req, hst_vci, rmt_vci);
#else
    int r;
    if ((r = MPIDI_av_is_local(av)))
        mpi_errno =
...
MPL_STATIC_INLINE_PREFIX int MPIDI_send_safe(const void *buf,
                                             ...
                                             int tag,
                                             MPIR_Comm * comm, int context_offset,
                                             MPIDI_av_entry_t * av, MPIR_Request ** req, int hst_vci, int rmt_vci)
{
    ...
    MPID_THREAD_SAFE_BEGIN(VCI, MPIDI_VCI(hst_vci).lock, cs_acq);
    ...
    if (!cs_acq) {
        ...
        *(req) = NULL;
        ...
        mpi_errno =
            MPIDI_send_unsafe(buf, count, datatype, rank, tag, comm, context_offset, av, req, hst_vci, rmt_vci);
    }

  fn_exit:
    MPID_THREAD_SAFE_END(VCI, MPIDI_VCI(hst_vci).lock, cs_acq);
                                              ...
                                              int hst_vci, int rmt_vci)
{
    ...
    if (!cs_acq) {
        ...
        *(req) = NULL;
        MPIDI_workq_vci_progress_unsafe();
        mpi_errno =
            MPIDI_isend_unsafe(buf, count, datatype, rank, tag, comm, context_offset, av, req, hst_vci, rmt_vci);
    }
                                              ...
                                              int hst_vci, int rmt_vci)
{
    ...
    if (!cs_acq) {
        ...
        *(req) = NULL;
        MPIDI_workq_vci_progress_unsafe();
        mpi_errno =
            MPIDI_ssend_unsafe(buf, count, datatype, rank, tag, comm, context_offset, av, req, hst_vci, rmt_vci);
    }
                                               ...
                                               int hst_vci, int rmt_vci)
{
    ...
    if (!cs_acq) {
        ...
        *(req) = NULL;
        MPIDI_workq_vci_progress_unsafe();
        mpi_errno =
            MPIDI_issend_unsafe(buf, count, datatype, rank, tag, comm, context_offset, av, req, hst_vci, rmt_vci);
    }
                                       ...
                                       MPIR_Request ** request)
{
    ...
    av = MPIDIU_comm_rank_to_av(comm, rank);
    mpi_errno =
        MPIDI_send_safe(buf, count, datatype, rank, tag, comm, context_offset, av, request, hst_vci, rmt_vci);
                                        ...
                                        MPIR_Request ** request)
{
    ...
    av = MPIDIU_comm_rank_to_av(comm, rank);
    mpi_errno =
        MPIDI_isend_safe(buf, count, datatype, rank, tag, comm, context_offset, av, request, hst_vci, rmt_vci);
                                        ...
                                        MPIR_Request ** request)
{
    ...
    av = MPIDIU_comm_rank_to_av(comm, rank);
    mpi_errno =
        MPIDI_ssend_safe(buf, count, datatype, rank, tag, comm, context_offset, av, request, hst_vci, rmt_vci);
                                         ...
                                         MPIR_Request ** request)
{
    ...
    av = MPIDIU_comm_rank_to_av(comm, rank);
    mpi_errno =
        MPIDI_issend_safe(buf, count, datatype, rank, tag, comm, context_offset, av, request, hst_vci, rmt_vci);
